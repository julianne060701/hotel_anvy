      ...
      <div class="room__grid">
        ...
        <div class="room__card">
          ...
          <div class="room__card__details">
            <div>
              <h4>{{ $r->room_type }}</h4>
              <p>Room is good for {{ $r->capacity }} Guest, with {{ $r->getBedType->type }} Bed and 1 Toilet with Shower.</p>
            </div>
            <h3>₱{{ $r->rate }}<span>/night</span></h3>
          </div>
        </div>
        @endforeach
      </div>
    ...
    <section class="menu" id="menu">
      <div class="section__container menu__container">
        ...
        <div class="menu__images">
          <img src="public/room/menu1.PNG" alt="menu" />
          <img src="public/room/menu2.PNG" alt="menu" />
          <img src="public/room/menu3.PNG" alt="menu" />
        </div>
