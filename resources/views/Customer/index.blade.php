...
<html lang="en">
    ...
    <body>
        ...
        <!--================Banner Area =================-->
        <section class="banner_area" style = "background-image: url(public/images/banner.jpg); background-repeat: no-repeat; background-size: cover;">
                ...
                <div class="row">
                    <div class="col-md-6 d_flex align-items-center">
                        <div class="about_content ">
                            ...
                            Whether you seek relaxation by the pool, adventure in our surrounding nature, or culinary delights in our exquisite restaurants, we're here to cater to your every need.
                            </p>
                ...
                <div class="row mb_30">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="img-fluid" src="public/images/menus/menu1.jpg" alt="post">
                            </div>
                            <div class="details">
                            <h5>$250</h5>
                                <a href="#"><h4 class="sec_h4">idk Salad</h4></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="img-fluid" src="public/images/menus/menu2.jpg" alt="post">
                            </div>
                            <div class="details">
                            <h5>$250</h5>
                                <a href="#"><h4 class="sec_h4">Cheezy Burger</h4></a>
                                <a href="#" class="btn theme_btn button_hover">Order Now</a>
                            </div>	
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="img-fluid" src="public/images/menus/menu3.jpg" alt="post">
                            </div>
                            <div class="details">
                            <h5>$250</h5>
                                <a href="#"><h4 class="sec_h4">Toast</h4></a>
                                <a href="#" class="btn theme_btn button_hover">Order Now</a>
                            </div>	
                        </div>
                    </div>
        ...
        <section class="about_history_area section_gap">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img class="img-fluid" src="public/images/about.jpg" alt="img">
                    </div>
                </div>
            </div>
        </section>
