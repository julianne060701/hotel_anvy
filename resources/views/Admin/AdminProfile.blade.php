                    ...
                    <form>
                        ...
                        <div class="row gx-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="inputPassword" type="tel" placeholder="Enter your phone number" value="*****" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputPassword">Confirm Password</label>
                                <input class="form-control" id="inputPassword" type="text" name="password" placeholder="Enter your password" value="*****" readonly>
                            </div>
                        </div>
                        <!-- Save changes button-->
